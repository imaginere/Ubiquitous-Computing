...
console.log(inMessage);  //log the entire response
    ...
    // I'm making a function to check the colour that I received and make a circle of it.
    // compare two arrays and then convert the colour text into RGB values
  
    //text(returnedAnswer[5],5,30);
